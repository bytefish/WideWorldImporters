...
namespace WideWorldImporters.Shared.ApiSdk.Odata.StockItemTransactions.Item.Supplier {
    ...
    public class SupplierRequestBuilder : BaseRequestBuilder {
        ...
        public SupplierRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/StockItemTransactions/{stockItemTransactionId}/supplier{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SupplierRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SupplierRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/StockItemTransactions/{stockItemTransactionId}/supplier{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
...
#nullable enable
        public async Task<WideWorldImporters.Shared.ApiSdk.Models.WideWorldImportersService.Supplier?> GetAsync(Action<SupplierRequestBuilderGetRequestConfiguration>? requestConfiguration = default, CancellationToken cancellationToken = default) {
#nullable restore
#else
        public async Task<WideWorldImporters.Shared.ApiSdk.Models.WideWorldImportersService.Supplier> GetAsync(Action<SupplierRequestBuilderGetRequestConfiguration> requestConfiguration = default, CancellationToken cancellationToken = default) {
#endif
