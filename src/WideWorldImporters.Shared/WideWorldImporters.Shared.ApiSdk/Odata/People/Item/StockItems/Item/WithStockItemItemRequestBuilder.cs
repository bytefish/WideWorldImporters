...
namespace WideWorldImporters.Shared.ApiSdk.Odata.People.Item.StockItems.Item {
    ...
    public class WithStockItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithStockItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/stockItems/{stockItemId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithStockItemItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStockItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/stockItems/{stockItemId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
