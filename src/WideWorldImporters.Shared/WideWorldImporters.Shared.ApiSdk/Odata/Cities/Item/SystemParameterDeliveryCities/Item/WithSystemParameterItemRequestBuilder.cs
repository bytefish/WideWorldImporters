...
namespace WideWorldImporters.Shared.ApiSdk.Odata.Cities.Item.SystemParameterDeliveryCities.Item {
    ...
    public class WithSystemParameterItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSystemParameterItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Cities/{cityId}/systemParameterDeliveryCities/{systemParameterId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithSystemParameterItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSystemParameterItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Cities/{cityId}/systemParameterDeliveryCities/{systemParameterId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
