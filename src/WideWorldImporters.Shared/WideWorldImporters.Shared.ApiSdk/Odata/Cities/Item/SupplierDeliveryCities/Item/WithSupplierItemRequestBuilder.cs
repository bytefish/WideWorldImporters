...
namespace WideWorldImporters.Shared.ApiSdk.Odata.Cities.Item.SupplierDeliveryCities.Item {
    ...
    public class WithSupplierItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSupplierItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Cities/{cityId}/supplierDeliveryCities/{supplierId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithSupplierItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSupplierItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Cities/{cityId}/supplierDeliveryCities/{supplierId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
