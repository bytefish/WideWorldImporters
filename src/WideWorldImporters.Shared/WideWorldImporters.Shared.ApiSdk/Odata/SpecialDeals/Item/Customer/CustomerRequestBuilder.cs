...
namespace WideWorldImporters.Shared.ApiSdk.Odata.SpecialDeals.Item.Customer {
    ...
    public class CustomerRequestBuilder : BaseRequestBuilder {
        ...
        public CustomerRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/SpecialDeals/{specialDealId}/customer{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomerRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomerRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/SpecialDeals/{specialDealId}/customer{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
