...
namespace WideWorldImporters.Shared.ApiSdk.Odata.BuyingGroups.Item.Customers.Item {
    ...
    public class WithCustomerItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCustomerItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/BuyingGroups/{buyingGroupId}/customers/{customerId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCustomerItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCustomerItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/BuyingGroups/{buyingGroupId}/customers/{customerId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
