...
namespace WideWorldImporters.Shared.ApiSdk.Odata.TransactionTypes.Item.CustomerTransactions {
    ...
    public class CustomerTransactionsRequestBuilder : BaseRequestBuilder {
        ...
        public CustomerTransactionsRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/TransactionTypes/{transactionTypeId}/customerTransactions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new CustomerTransactionsRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CustomerTransactionsRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/TransactionTypes/{transactionTypeId}/customerTransactions{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
