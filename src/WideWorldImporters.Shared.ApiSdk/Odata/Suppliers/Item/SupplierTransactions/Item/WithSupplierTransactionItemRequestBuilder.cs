...
namespace WideWorldImporters.Shared.ApiSdk.Odata.Suppliers.Item.SupplierTransactions.Item {
    ...
    public class WithSupplierTransactionItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSupplierTransactionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Suppliers/{supplierId}/supplierTransactions/{supplierTransactionId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithSupplierTransactionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSupplierTransactionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Suppliers/{supplierId}/supplierTransactions/{supplierTransactionId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
