...
namespace WideWorldImporters.Shared.ApiSdk.Odata.Orders.Item.InverseBackorderOrder.Item {
    ...
    public class WithOrderItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithOrderItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Orders/{orderId}/inverseBackorderOrder/{orderId1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithOrderItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithOrderItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Orders/{orderId}/inverseBackorderOrder/{orderId1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
