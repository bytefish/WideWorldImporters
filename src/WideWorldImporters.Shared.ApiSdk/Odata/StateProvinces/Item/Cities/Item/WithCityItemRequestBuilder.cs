...
namespace WideWorldImporters.Shared.ApiSdk.Odata.StateProvinces.Item.Cities.Item {
    ...
    public class WithCityItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithCityItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/StateProvinces/{stateProvinceId}/cities/{cityId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithCityItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithCityItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/StateProvinces/{stateProvinceId}/cities/{cityId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
