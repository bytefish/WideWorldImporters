...
namespace WideWorldImporters.Shared.ApiSdk.Odata.SupplierTransactions.Item.Supplier {
    ...
    public class SupplierRequestBuilder : BaseRequestBuilder {
        ...
        public SupplierRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/SupplierTransactions/{supplierTransactionId}/supplier{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new SupplierRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SupplierRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/SupplierTransactions/{supplierTransactionId}/supplier{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
