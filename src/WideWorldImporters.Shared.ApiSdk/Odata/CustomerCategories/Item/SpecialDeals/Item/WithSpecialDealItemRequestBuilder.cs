...
namespace WideWorldImporters.Shared.ApiSdk.Odata.CustomerCategories.Item.SpecialDeals.Item {
    ...
    public class WithSpecialDealItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSpecialDealItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/CustomerCategories/{customerCategoryId}/specialDeals/{specialDealId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithSpecialDealItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSpecialDealItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/CustomerCategories/{customerCategoryId}/specialDeals/{specialDealId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
