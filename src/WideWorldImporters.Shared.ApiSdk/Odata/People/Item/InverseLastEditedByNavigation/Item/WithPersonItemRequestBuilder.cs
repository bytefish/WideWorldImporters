...
namespace WideWorldImporters.Shared.ApiSdk.Odata.People.Item.InverseLastEditedByNavigation.Item {
    ...
    public class WithPersonItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithPersonItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/inverseLastEditedByNavigation/{personId1}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithPersonItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithPersonItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/inverseLastEditedByNavigation/{personId1}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
