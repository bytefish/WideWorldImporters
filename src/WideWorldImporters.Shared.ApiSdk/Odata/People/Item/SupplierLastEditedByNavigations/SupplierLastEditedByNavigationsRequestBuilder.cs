...
namespace WideWorldImporters.Shared.ApiSdk.Odata.People.Item.SupplierLastEditedByNavigations {
    ...
    public class SupplierLastEditedByNavigationsRequestBuilder : BaseRequestBuilder 
    {
        ...
        /// <summary>
        /// Instantiates a new <see cref="SupplierLastEditedByNavigationsRequestBuilder"/> and sets the default values.
        /// </summary>
...
#nullable enable
        public async Task<SupplierCollectionResponse?> GetAsync(Action<RequestConfiguration<SupplierLastEditedByNavigationsRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
#nullable restore
#else
        public async Task<SupplierCollectionResponse> GetAsync(Action<RequestConfiguration<SupplierLastEditedByNavigationsRequestBuilderGetQueryParameters>> requestConfiguration = default, CancellationToken cancellationToken = default)
...
#if NETSTANDARD2_1_OR_GREATER || NETCOREAPP3_1_OR_GREATER
#nullable enable
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SupplierLastEditedByNavigationsRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
#nullable restore
#else
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<SupplierLastEditedByNavigationsRequestBuilderGetQueryParameters>> requestConfiguration = default)
        ...
        /// </summary>
        /// <returns>A <see cref="SupplierLastEditedByNavigationsRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
...
#nullable restore
        ...
        public class SupplierLastEditedByNavigationsRequestBuilderGetRequestConfiguration : RequestConfiguration<SupplierLastEditedByNavigationsRequestBuilderGetQueryParameters> 
        {
        }
    }
}
