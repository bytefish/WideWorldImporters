...
namespace WideWorldImporters.Shared.ApiSdk.Odata.People.Item.OrderSalespersonPeople.Item {
    ...
    public class WithOrderItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithOrderItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/orderSalespersonPeople/{orderId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithOrderItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithOrderItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/orderSalespersonPeople/{orderId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
