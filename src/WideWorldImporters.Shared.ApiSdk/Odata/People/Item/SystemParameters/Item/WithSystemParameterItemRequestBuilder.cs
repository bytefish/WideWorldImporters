...
namespace WideWorldImporters.Shared.ApiSdk.Odata.People.Item.SystemParameters.Item {
    ...
    public class WithSystemParameterItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithSystemParameterItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/systemParameters/{systemParameterId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithSystemParameterItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithSystemParameterItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/People/{personId}/systemParameters/{systemParameterId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
