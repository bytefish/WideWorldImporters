...
namespace WideWorldImporters.Shared.ApiSdk.Odata.PurchaseOrders.Item.PurchaseOrderLines {
    ...
    public class PurchaseOrderLinesRequestBuilder : BaseRequestBuilder {
        ...
        public PurchaseOrderLinesRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/PurchaseOrders/{purchaseOrderId}/purchaseOrderLines{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new PurchaseOrderLinesRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public PurchaseOrderLinesRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/PurchaseOrders/{purchaseOrderId}/purchaseOrderLines{?%24top,%24skip,%24search,%24filter,%24count,%24orderby,%24select,%24expand}", rawUrl) {
        }
        /// <summary>
