...
namespace WideWorldImporters.Shared.ApiSdk.Odata.Invoices.Item.StockItemTransactions.Item {
    ...
    public class WithStockItemTransactionItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithStockItemTransactionItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Invoices/{invoiceId}/stockItemTransactions/{stockItemTransactionId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithStockItemTransactionItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStockItemTransactionItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/Invoices/{invoiceId}/stockItemTransactions/{stockItemTransactionId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
