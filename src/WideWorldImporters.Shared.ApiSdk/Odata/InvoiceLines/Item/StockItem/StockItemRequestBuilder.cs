...
namespace WideWorldImporters.Shared.ApiSdk.Odata.InvoiceLines.Item.StockItem {
    ...
    public class StockItemRequestBuilder : BaseRequestBuilder {
        ...
        public StockItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/InvoiceLines/{invoiceLineId}/stockItem{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new StockItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public StockItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/InvoiceLines/{invoiceLineId}/stockItem{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
