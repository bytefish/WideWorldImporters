...
namespace WideWorldImporters.Shared.ApiSdk.Odata.PackageTypes.Item.StockItemUnitPackages.Item {
    ...
    public class WithStockItemItemRequestBuilder : BaseRequestBuilder {
        ...
        public WithStockItemItemRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/PackageTypes/{packageTypeId}/stockItemUnitPackages/{stockItemId}{?%24select,%24expand}", pathParameters) {
        }
        /// <summary>
        /// Instantiates a new WithStockItemItemRequestBuilder and sets the default values.
        /// </summary>
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public WithStockItemItemRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/odata/PackageTypes/{packageTypeId}/stockItemUnitPackages/{stockItemId}{?%24select,%24expand}", rawUrl) {
        }
        /// <summary>
